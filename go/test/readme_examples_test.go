...
const testSeed = `map[string]any{"entity": map[string]any{"calc": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "resolve": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tokenize": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
