...
func TestResolveEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		resolveRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.resolve")))
...
func resolveBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("MATH_FUNCTION_PARSER_TEST_RESOLVE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["MATH_FUNCTION_PARSER_TEST_RESOLVE_ENTID"])
