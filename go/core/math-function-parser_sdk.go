...
func (sdk *MathFunctionParserSDK) OptionsMap() map[string]any {
...
func (sdk *MathFunctionParserSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MathFunctionParserSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MathFunctionParserSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MathFunctionParserSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MathFunctionParserSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MathFunctionParserSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MathFunctionParserSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MathFunctionParserSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MathFunctionParserSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MathFunctionParserSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *MathFunctionParserSDK {
	...
	sdk := NewMathFunctionParserSDK(sdkopts)
	sdk.Mode = "test"
