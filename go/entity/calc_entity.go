...
func NewCalcEntity(client *core.MathFunctionParserSDK, entopts map[string]any) *CalcEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CalcEntity) GetName() string { return e.name }
...
func (e *CalcEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CalcEntity) Deleted() bool {
	return e.deleted
}


func (e *CalcEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCalcEntity(e.client, opts)
}

func (e *CalcEntity) Data(args ...any) any {
...
func (e *CalcEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Calc; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CalcEntity) DataTyped(data ...Calc) Calc {
	if len(data) > 0 {
		return typedFrom[Calc](e.Data(asMap(data[0])))
	}
	return typedFrom[Calc](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Calc (all fields
// optional at the wire level).
func (e *CalcEntity) MatchTyped(match ...Calc) Calc {
	if len(match) > 0 {
		return typedFrom[Calc](e.Match(asMap(match[0])))
	}
	return typedFrom[Calc](e.Match())
}
...
func (e *CalcEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CalcEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CalcEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CalcListMatch and returns []Calc. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CalcEntity) ListTyped(reqmatch CalcListMatch, ctrl map[string]any) ([]Calc, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Calc](res), nil
}



func (e *CalcEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CalcEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CalcEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CalcEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
