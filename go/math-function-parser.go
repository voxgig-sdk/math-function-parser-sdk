...
// instead of `sdk.NewMathFunctionParserSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *MathFunctionParserSDK  { return NewMathFunctionParserSDK(nil) }
func Test() *MathFunctionParserSDK { return TestSDK(nil, nil) }
