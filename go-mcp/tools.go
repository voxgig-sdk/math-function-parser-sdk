...
type Args struct {
	Entity string         `json:"entity" jsonschema:"calc | resolve | tokenize"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MathFunctionParserSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "math-function-parser_list",
		Description: "List records from MathFunctionParser. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "math-function-parser_load",
		Description: "Load a single record from MathFunctionParser. " +
...
func runOp(client *sdk.MathFunctionParserSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MathFunctionParserSDK, name string) (sdk.MathFunctionParserEntity, error) {
	...
	case "tokenize":
		return client.Tokenize(nil), nil
