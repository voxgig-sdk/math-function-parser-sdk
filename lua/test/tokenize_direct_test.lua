...
describe("TokenizeDirect", function()
  it("should direct-list-tokenize", function()
    local setup = tokenize_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-tokenize", setup.live and "live" or "unit")
...
function tokenize_direct_setup(mockres)
