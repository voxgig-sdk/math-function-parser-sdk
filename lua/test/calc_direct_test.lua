...
describe("CalcDirect", function()
  it("should direct-list-calc", function()
    local setup = calc_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-calc", setup.live and "live" or "unit")
...
function calc_direct_setup(mockres)
