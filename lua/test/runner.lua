...
function runner.env_override(m)
  local live = runner.getenv("MATHFUNCTIONPARSER_TEST_LIVE")
  local override = runner.getenv("MATHFUNCTIONPARSER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MATHFUNCTIONPARSER_TEST_EXPLAIN")
