...
function runner.env_override(m)
  local live = runner.getenv("MATH_FUNCTION_PARSER_TEST_LIVE")
  local override = runner.getenv("MATH_FUNCTION_PARSER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MATH_FUNCTION_PARSER_TEST_EXPLAIN")
