// Command MathFunctionParser-cli is a CLI + REPL for the MathFunctionParser SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      MATH_FUNCTION_PARSER_APIKEY (api key), MATH_FUNCTION_PARSER_BASE (base url override)")
