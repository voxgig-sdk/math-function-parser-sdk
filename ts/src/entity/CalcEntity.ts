...
class CalcEntity extends MathFunctionParserEntityBase<Calc> {
  ...
  make(this: CalcEntity) {
    return new CalcEntity(this._client, this.entopts())
  }
  ...
  async list(this: any, reqmatch?: CalcListMatch, ctrl?: Control): Promise<CalcEntity[]> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Calc[]> return stays clean under strict null checks.
