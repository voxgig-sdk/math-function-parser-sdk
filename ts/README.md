...
- Releases: [https://github.com/voxgig-sdk/math-function-parser-sdk/releases](https://github.com/voxgig-sdk/math-function-parser-sdk/releases)
...
// calc.match() returns { id: "example_id" }
```
