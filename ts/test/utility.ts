...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MATHFUNCTIONPARSER_TEST_LIVE ||
    'TRUE' === process.env.MATHFUNCTIONPARSER_TEST_OVERRIDE
  ) {
  ...
  m.MATHFUNCTIONPARSER_TEST_EXPLAIN = process.env.MATHFUNCTIONPARSER_TEST_EXPLAIN || m.MATHFUNCTIONPARSER_TEST_EXPLAIN
