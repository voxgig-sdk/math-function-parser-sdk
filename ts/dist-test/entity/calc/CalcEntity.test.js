...
(0, node_test_1.describe)('CalcEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'calc.' + op, live))
                return;
        }
        ...
        let calc_ref01_data = Object.values(setup.data.existing.calc)[0];
        // LIST
        const calc_ref01_ent = client.Calc();
        const calc_ref01_match = {};
        const calc_ref01_list = (await calc_ref01_ent.list(calc_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/calc/CalcTestData.json');
    ...
    let idmap = transform(['calc01', 'calc02', 'calc03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['MATH_FUNCTION_PARSER_TEST_CALC_ENTID'];
...
//# sourceMappingURL=CalcEntity.test.js.map