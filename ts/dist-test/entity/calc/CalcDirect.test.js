...
(0, node_test_1.describe)('CalcDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-calc', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-calc', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MATH_FUNCTION_PARSER_TEST_CALC_ENTID'];
...
//# sourceMappingURL=CalcDirect.test.js.map