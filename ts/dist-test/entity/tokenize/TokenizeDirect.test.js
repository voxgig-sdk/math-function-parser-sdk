...
(0, node_test_1.describe)('TokenizeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MathFunctionParserSDK({
    ...
    (0, node_test_1.test)('direct-list-tokenize', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-tokenize', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.MATH_FUNCTION_PARSER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MathFunctionParserSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MATH_FUNCTION_PARSER_TEST_TOKENIZE_ENTID'];
    ...
    const client = new __1.MathFunctionParserSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TokenizeDirect.test.js.map