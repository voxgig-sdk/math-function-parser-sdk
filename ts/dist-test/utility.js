...
function envOverride(m) {
    if ('TRUE' === process.env.MATH_FUNCTION_PARSER_TEST_LIVE ||
        'TRUE' === process.env.MATH_FUNCTION_PARSER_TEST_OVERRIDE) {
    ...
    m.MATH_FUNCTION_PARSER_TEST_EXPLAIN = process.env.MATH_FUNCTION_PARSER_TEST_EXPLAIN || m.MATH_FUNCTION_PARSER_TEST_EXPLAIN;
    return m;
}
