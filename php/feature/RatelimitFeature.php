...
// MathFunctionParser SDK ratelimit feature
...
class MathFunctionParserRatelimitFeature extends MathFunctionParserBaseFeature
{
    ...
    private function _acquire(MathFunctionParserContext $ctx): void
    {
    ...
    private function _track(MathFunctionParserContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
