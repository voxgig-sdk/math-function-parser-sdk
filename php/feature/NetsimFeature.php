...
// MathFunctionParser SDK netsim feature
...
class MathFunctionParserNetsimFeature extends MathFunctionParserBaseFeature
{
    ...
    private function _simulate(MathFunctionParserContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MathFunctionParserContext $ctx, array $applied): void
    {
        $client = $this->client;
