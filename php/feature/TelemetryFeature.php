...
// MathFunctionParser SDK telemetry feature
...
class MathFunctionParserTelemetryFeature extends MathFunctionParserBaseFeature
{
    ...
    private function _close(MathFunctionParserContext $ctx, bool $ok): void
    {
