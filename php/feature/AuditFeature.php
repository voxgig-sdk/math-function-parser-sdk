...
// MathFunctionParser SDK audit feature
...
class MathFunctionParserAuditFeature extends MathFunctionParserBaseFeature
{
    ...
    private function _emit(MathFunctionParserContext $ctx, string $outcome): void
    {
