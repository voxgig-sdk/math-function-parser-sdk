...
// MathFunctionParser SDK metrics feature
...
class MathFunctionParserMetricsFeature extends MathFunctionParserBaseFeature
{
    ...
    private function _record(MathFunctionParserContext $ctx, bool $ok): void
    {
