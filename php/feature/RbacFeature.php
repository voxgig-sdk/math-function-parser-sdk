...
// MathFunctionParser SDK rbac feature
...
class MathFunctionParserRbacFeature extends MathFunctionParserBaseFeature
{
    ...
    private function _required(MathFunctionParserContext $ctx): ?string
    {
    ...
    private function _reject(MathFunctionParserContext $ctx, string $required): void
    {
    ...
    private function _track(MathFunctionParserContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
