...
// MathFunctionParser SDK debug feature
...
class MathFunctionParserDebugFeature extends MathFunctionParserBaseFeature
{
    ...
    private function _finish(MathFunctionParserContext $ctx, bool $ok): void
    {
