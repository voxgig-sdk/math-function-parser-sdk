# MathFunctionParser PHP SDK

The PHP SDK for the MathFunctionParser API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Calc(null)->list(null, null);
...
[$result, $err] = $client->MathFunctionParser(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── mathfunctionparser_sdk.php          -- Main SDK class
...
The main class (`mathfunctionparser_sdk.php`) exports the SDK class
