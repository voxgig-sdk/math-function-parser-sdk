...
// MathFunctionParser SDK Calc entity
...
class CalcEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CalcEntity($this->_client, $opts);
    }

    /**
     * @param Calc|array $args Calc data (assoc-array) to store.
     */
    ...
    /**
     * @return Calc|array The current Calc data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Calc fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Calc fields).
     */
    ...
    /**
     * List Calc items matching the given filter.
     *
     * @param CalcListMatch|array|null $reqmatch Match filter (any subset
     *   of Calc fields) as an assoc-array; CalcListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Calc[]|array A list of Calc items as assoc-arrays at
