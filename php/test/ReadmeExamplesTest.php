...
// MathFunctionParser SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MathFunctionParserSDK::test)
...
{
    private const SDK_CLASS = 'MathFunctionParserSDK';
    ...
    private const SDK_BASE = 'mathfunctionparser_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../mathfunctionparser_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
