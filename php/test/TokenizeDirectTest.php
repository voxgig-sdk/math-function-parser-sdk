...
class TokenizeDirectTest extends TestCase
{
    public function test_direct_list_tokenize(): void
    {
        $setup = tokenize_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-tokenize", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
