...
class CalcDirectTest extends TestCase
{
    public function test_direct_list_calc(): void
    {
        $setup = calc_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-calc", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
