...
// MathFunctionParser SDK utility type

class MathFunctionParserUtility
{
    ...
    public static function copy(MathFunctionParserUtility $src): MathFunctionParserUtility
    {
        $u = new MathFunctionParserUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
