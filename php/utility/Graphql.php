...
// MathFunctionParser SDK utility: graphql
//
...
class MathFunctionParserGraphql
{
    ...
    // equivalent.
    public static function body(MathFunctionParserContext $ctx): mixed
    {
    ...
    public static function errors(MathFunctionParserContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
