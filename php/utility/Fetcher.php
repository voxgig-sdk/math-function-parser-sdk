...
// MathFunctionParser SDK utility: fetcher

class MathFunctionParserFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MathFunctionParserSDK/1.0)';
    ...
    public static function call(MathFunctionParserContext $ctx, string $fullurl, array $fetchdef): array
    {
