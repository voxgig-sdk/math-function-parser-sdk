...
|---|---|---|
| `ts/` | @voxgig-sdk/math-function-parser-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/math-function-parser-sdk \
      --repository voxgig-sdk/math-function-parser-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/math-function-parser-sdk` shows it, and
`npm trust revoke @voxgig-sdk/math-function-parser-sdk --id=<id>` removes it.
