...
// MathFunctionParser SDK clienttrack feature
...
class MathFunctionParserClienttrackFeature extends MathFunctionParserBaseFeature
{
    ...
    public function PostConstruct(MathFunctionParserContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MathFunctionParser-SDK';
