...
// MathFunctionParser SDK streaming feature
...
class MathFunctionParserStreamingFeature extends MathFunctionParserBaseFeature
{
    ...
    private function _iterate(MathFunctionParserResult $result): \Generator
    {
    ...
    private function _streamable(MathFunctionParserContext $ctx): bool
    {
