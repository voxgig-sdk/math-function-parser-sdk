...
// MathFunctionParser SDK cache feature
...
class MathFunctionParserCacheFeature extends MathFunctionParserBaseFeature
{
    ...
    private function _through(MathFunctionParserContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
