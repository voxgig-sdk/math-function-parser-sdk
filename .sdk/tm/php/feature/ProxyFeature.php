...
// MathFunctionParser SDK proxy feature
...
class MathFunctionParserProxyFeature extends MathFunctionParserBaseFeature
{
    ...
    public function init(MathFunctionParserContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MathFunctionParserContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
