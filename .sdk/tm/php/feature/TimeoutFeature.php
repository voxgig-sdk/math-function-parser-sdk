...
// MathFunctionParser SDK timeout feature
...
class MathFunctionParserTimeoutFeature extends MathFunctionParserBaseFeature
{
    ...
    private function _with_timeout(MathFunctionParserContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MathFunctionParserContext $_ctx, float $ms): void
    {
        $client = $this->client;
