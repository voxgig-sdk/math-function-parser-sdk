...
// MathFunctionParser SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MathFunctionParserMakeRequest
{
    public static function call(MathFunctionParserContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MathFunctionParserResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MathFunctionParserResponse($fetched);
        } else {
