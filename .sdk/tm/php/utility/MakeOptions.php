...
// MathFunctionParser SDK utility: make_options

class MathFunctionParserMakeOptions
{
    ...
    public static function call(MathFunctionParserContext $ctx): array
    {
        ...
        //
        // `MathFunctionParserSchema::optspec()` is built from the model:
        ...
        $optspec = MathFunctionParserSchema::optspec();
