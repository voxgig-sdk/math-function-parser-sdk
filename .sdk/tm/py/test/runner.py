...
class MathFunctionParserTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MathFunctionParserTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MathFunctionParserTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MathFunctionParserTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
