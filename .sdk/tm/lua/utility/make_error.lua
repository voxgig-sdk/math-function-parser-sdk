...
local function make_error_util(ctx, err)
  ...
  local msg = "MathFunctionParserSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = MathFunctionParserError.new("", msg, ctx)
  sdk_err.result = ctx.utility.clean(ctx, result)
  sdk_err.spec = ctx.utility.clean(ctx, spec)

  if type(err) == "table" and getmetatable(err) == MathFunctionParserError then
