# MathFunctionParser SDK Resolve entity
...
class ResolveEntity
  ...
  # @return [Resolve, Hash] the loaded Resolve; raises MathFunctionParserError on failure
    ...
    _run_op(ctx) do
      if ctx.result
        ...
        if ctx.result.resdata
          @_data = MathFunctionParserHelpers.to_map(VoxgigStruct.clone(ctx.result.resdata)) || {}
        end
      end
    end
  end
