...
class TokenizeEntity
  ...
  def make
    opts = @_entopts.dup
    TokenizeEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [TokenizeListMatch, Hash, nil] match filter (any subset of
  #   Tokenize fields); defaults to nil, treated as an empty match that lists all.
