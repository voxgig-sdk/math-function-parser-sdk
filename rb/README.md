# MathFunctionParser Ruby SDK

The Ruby SDK for the MathFunctionParser API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.MathFunctionParser(nil).load(
  { "id" => "test01" }, nil
)
...
```
rb/
├── MathFunctionParser_sdk.rb       -- Main SDK module
