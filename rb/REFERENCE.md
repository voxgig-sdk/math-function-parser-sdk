# MathFunctionParser Ruby SDK Reference

Complete API reference for the MathFunctionParser Ruby SDK.
...
#### `MathFunctionParserSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Calc.list(nil)
```
...
```ruby
results, err = client.Tokenize.list(nil)
```
