...
class TokenizeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MATHFUNCTIONPARSER_TEST_TOKENIZE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def tokenize_basic_setup(extra)
  ...
  entid_env_raw = ENV["MATHFUNCTIONPARSER_TEST_TOKENIZE_ENTID"]
