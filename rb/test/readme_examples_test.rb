...
#      offline in seeded test mode (MathFunctionParserSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MathFunctionParser_sdk.rb")
  SDK_CLASS = "MathFunctionParserSDK"
  ...
  SDK_BASE = "MathFunctionParser_sdk"
