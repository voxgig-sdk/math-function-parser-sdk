# MathFunctionParser SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MathFunctionParserSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MathFunctionParserSDK(...) and MathFunctionParserSDK.test(...) become
#      MathFunctionParserSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mathfunctionparser_sdk"
_SDK_CLASS = "MathFunctionParserSDK"
