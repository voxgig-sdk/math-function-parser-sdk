...
from mathfunctionparser_sdk.utility import register

# Load features
from mathfunctionparser_sdk.feature.base_feature import MathFunctionParserBaseFeature
from mathfunctionparser_sdk.features import _has_feature, _make_feature
...
class MathFunctionParserSDK:
    ...
    def get_utility(self):
        return MathFunctionParserUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MathFunctionParserSDK: graphql: " + str(msg))
            res["graphql"] = errors
